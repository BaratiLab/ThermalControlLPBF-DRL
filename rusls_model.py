...
# def square(resolution = 20e-6, plotting = False, bc = 'flux'):
#     c = 0
#     test = EagarTsai(resolution = resolution, bc = bc, spacing = 200e-6)
#     time = 1000e-6
#     test.forward(time, 0)
#     test.plot()
#     res_text = str(int(resolution/1e-6))
# file_prefix = "baseline_simulation_figs/square" + '_' + res_text + '_' + bc
# plt.savefig(file_prefix +  '%04d' % 0 + ".png")
...
#     test.plot()
#     plt.savefig(file_prefix + '%04d' % 1 + ".png")
#     c = c+1
#     print("Frame: " + str(c))
#     plt.clf()
...
#     test.plot()
#     plt.savefig(file_prefix +  '%04d' % 2 + ".png")
#     c = c+1
#     print("Frame: " + str(c))
#     plt.clf()
...
#     test.forward(time, -np.pi/2)
#     test.plot()
#     plt.savefig(file_prefix +'%04d' %  3 + ".png")
#     c = c+1
#     print("Frame: " + str(c))
#     plt.clf()


    oscommand = 'convert ' + file_prefix + '*png -delay 10 ' + file_prefix + '.gif'
...
def zigzag(plotting = False, resolution = 10e-6, bc = 'flux'):
    ...
    c = 0
    res_text = str(int(resolution/1e-6))
    #folder_prefix = 'baseline_simulation_figs/' +  
    file_prefix = "baseline_simulation_figs/zz" + '_' + res_text + '_' + bc + '/'
    ...
    for iter in range(21):
        ...
        if iter % 4 == 0:
            for dt in np.arange(0, 1200e-6, 125e-6):
                ...
                if plotting:            
                    figures = zz.plot()
                    figures[0].savefig('close20zz_x' +  '%04d' % c + ".png")
                    figures[1].savefig('close20zz_y' +  '%04d' % c + ".png")
                    figures[2].savefig('close20zz_z' +  '%04d' % c + ".png")
                #plt.show()
                c += 1
                depth.append(zz.meltpool())
...
def triangle(plotting = False, resolution = 5e-6, bc = 'temp'):
    ...
    for i in range(12):
        ...
        for dt in np.arange(step, h/V, step):
            ...
            if plotting:
                figures = tri.plot()
                figures[0].savefig('triangle5_x' +  '%04d' % c + ".png")
                figures[1].savefig('triangle5_y' +  '%04d' % c + ".png")
                figures[2].savefig('triangle5_z' +  '%04d' % c + ".png")
...
def main():
    ...
    figuredirectory = './sample_simulation_figures'
    plotting = sys.argv[1] == 'True'
